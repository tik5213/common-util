 ...
 */
@DUnit(name = "正常分割线，设置 DividerId", group = DividerGroup.class)
public class TestItemDecorationDividerActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recycler_view.addItemDecoration(ItemDecorationUtil
                .setShowDividerLine()
                .setShowLastDividerLine(showLastDividerLine)
                .setDividerDrawableIdFreeze(R.drawable.layer_list_listview_divider2)
                .build()
        );
